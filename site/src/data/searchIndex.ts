...
const searchIndex: SearchEntry[] = [
  ...
  { path: '/rpc-client', title: 'RPC Client', section: 'Core Concepts', keywords: ['rpc', 'client', 'createClient', 'typed client', 'http client', 'type-safe', 'end-to-end types', 'app.fetch', 'in-process', 'no codegen', 'trpc'], description: 'Fully typed HTTP client with types inferred from your routes — zero codegen.' },
  ...
  { path: '/orm/migrations', title: 'Migrations', section: 'Vexor ORM', keywords: ['migration', 'migrate', 'rollback', 'alter', 'create table', 'schema change', 'auto migration', 'diff', 'schema diffing', 'snapshot', 'db:diff'], description: 'Versioned migrations, plus auto-migrations generated by schema diffing.' },
  ...
  { path: '/realtime/websocket', title: 'WebSocket', section: 'Real-Time & Events', keywords: ['websocket', 'ws', 'socket', 'app.ws', 'bidirectional', 'real-time', 'pub sub', 'topic', 'subscribe', 'publish', 'broadcast', 'websockets hub'], description: 'First-class WebSocket routes with app.ws(), topics, and the connection hub.' },
  ...
  { path: '/cli/commands', title: 'CLI Commands', section: 'CLI', keywords: ['commands', 'new', 'generate', 'add', 'dev', 'build', 'doctor', 'db:diff', 'create vexor', 'npm create'], description: 'Complete reference for all CLI commands.' },
