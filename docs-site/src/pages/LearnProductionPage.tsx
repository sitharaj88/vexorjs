...
const securityCode = `import { Vexor, Type } from '@vexorjs/core';
...
export default function LearnProductionPage() {
  return (
    <div className="space-y-12">
      <div>
        ...
        <h1 className="text-4xl font-bold mb-4 text-slate-900 dark:text-white">Production & DevOps</h1>
      ...
      <section id="docker">
        ...
        <div className="space-y-6">
          <CodeBlock code={dockerCode} filename="Dockerfile" showLineNumbers />
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              { threat: 'Broken Access Control', fix: 'Role-based middleware, validate ownership' },
      ...
      <section id="cicd">
        ...
        <CodeBlock code={cicdCode} filename=".github/workflows/ci.yml" showLineNumbers />
      </section>
      ...
      <section id="scaling">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-4">
          Use Node.js cluster module to utilize all CPU cores. Implement graceful shutdown for
      ...
      {/* Completion */}
      <section className="p-8 bg-gradient-to-br from-vexor-500/10 via-purple-500/10 to-blue-500/10 border border-vexor-500/20 rounded-2xl text-center">
        <div className="text-4xl mb-4">&#x1f389;</div>
        <h2 className="text-2xl font-bold mb-2 text-slate-900 dark:text-white">Training Complete!</h2>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <a href="/docs/getting-started" className="px-4 py-2 bg-vexor-500 hover:bg-vexor-600 text-white rounded-lg transition-colors font-medium text-sm">
            Start Building
          </a>
          <a href="/docs/core" className="px-4 py-2 bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-lg transition-colors font-medium text-sm">
            Explore Docs
          </a>
        </div>
      </section>
