  ...
  return (
    <div className="space-y-12">
      ...
      <section id="quick-start">
        ...
        <p className="text-slate-400 mb-4">
          Create a new file <code className="bg-slate-800 px-2 py-0.5 rounded text-sm">app.ts</code> and add the following code:
        </p>
        <CodeBlock code={basicAppCode} filename="app.ts" showLineNumbers />

        <div className="mt-6">
          <h3 className="text-lg font-semibold mb-3">Run Your Application</h3>
          <p className="text-slate-400 mb-4">
            Use <code className="bg-slate-800 px-2 py-0.5 rounded text-sm">tsx</code> or <code className="bg-slate-800 px-2 py-0.5 rounded text-sm">bun</code> to run your TypeScript file directly:
          </p>
...
bun run app.ts`} language="bash" />
      ...
      {/* Project Structure */}
      <section>
        <h2 className="text-2xl font-bold mb-4">Recommended Project Structure</h2>
        <p className="text-slate-400 mb-4">
      ...
      <section>
        ...
        <p className="text-slate-400 mb-4">
          Here's a recommended <code className="bg-slate-800 px-2 py-0.5 rounded text-sm">tsconfig.json</code> for Vexor projects:
        </p>
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Understand routing, context, and request handling</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Connect to PostgreSQL, MySQL, or SQLite with Vexor ORM</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Implement JWT or OAuth2 authentication</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Deploy to Node.js, Bun, AWS Lambda, or Edge</p>
            </div>
          </li>
        </ul>
      </section>
